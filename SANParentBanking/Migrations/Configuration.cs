        namespace SANParentBanking.Migrations
        {
            using System;
            ...
            internal sealed class Configuration : DbMigrationsConfiguration<SANParentBanking.Models.ApplicationDbContext>
            {
        ...
        protected override void Seed(Models.ApplicationDbContext context)
              ...
              "Recipient"
                    ...
                    var users = new[]
                    {
              new {Email = "kalgutsr@mail.uc.edu", Pwd = "Password123!", Roles = "Owner"},
              new {Email = "vaidyagv@mail.uc.edu", Pwd = "Password123!", Roles = "Owner"},
              new {Email = "royag@mail.uc.edu", Pwd = "Password123!", Roles = "Recipient"},
              new {Email = "neme@mail.uc.edu", Pwd = "Password123!", Roles = "Recipient"},
              new {Email = "guptan@mail.uc.edu", Pwd = "Password123!", Roles = "Recipient"},
           };
